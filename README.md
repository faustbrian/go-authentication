...
`go-authentication` is a production-oriented authentication library for Go
...
Go standard library. JWT, OIDC, and OpenTelemetry live in separate modules so
their dependency graphs are opt-in.
