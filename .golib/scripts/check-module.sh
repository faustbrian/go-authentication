...
run_gate() {
    ...
    case "${selected}" in
        ...
        licenses)
            ...
            if [[ "${module_path}" != "github.com/faustbrian/go-authentication" &&
                "${module_path}" != github.com/faustbrian/go-authentication/* ]]; then
            ...
            run_go_tool \
                ...
                go-licenses \
                check ./... \
                --ignore "github.com/faustbrian/go-authentication"
            ;;
        sbom)
            applicable security || { skip_not_applicable security; return; }
