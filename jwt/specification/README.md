...
| [JWT-DEC-011](../docs/specification-decisions.md) | rfc9110-source | TestRemoteRefreshWaitersShareResultAndHonorCancellation, TestRemoteSerializesAutomaticAndExplicitRefreshWork, TestRemoteLifetimeIsOwnedByShutdown, TestRemoteShutdownOwnsCompleteBoundedCleanup, TestRemoteConcurrentShutdownCallerContinuesCleanupAfterPriorCallerCancellation, TestRemoteShutdownReportsCanceledJoin, TestRemoteShutdownDeadlineIsNotBlockedByRefreshLock |
