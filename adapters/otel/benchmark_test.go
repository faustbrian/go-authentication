...
func (directInstrumenter) Begin(ctx context.Context, _ authentication.CredentialKind) (
	context.Context,
...
) authentication.BeginInstrumenter {
	b.Helper()
...
func instrumentedBenchmarkAuthenticator(
	...
	b.Helper()
	authenticator, err := authentication.NewInstrumentedWithBegin(base, instrumenter, fixedClock{})
	if err != nil {
		b.Fatalf("authentication.NewInstrumentedWithBegin() error = %v", err)
	}
