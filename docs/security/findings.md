...
- The root module remains dependency-free. Optional modules do not import
  `go-service`, `go-http-client`, or `go-authorization`; the executable
  boundary check prevents this repository from closing a dependency cycle.
